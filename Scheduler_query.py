...
async def main():
    ...
    scheduler.add_job(everyday_backup, CronTrigger(hour="17-23", minute="0"), id="backup_evening")
    scheduler.add_job(everyday_backup, CronTrigger(hour="0-2", minute="0"), id="backup_night")
